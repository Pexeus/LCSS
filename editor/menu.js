        ...
        if (path.extname(file) == ".css") {
            ...
            if (data[file] != undefined) {
                ...
                files.forEach(entry => {
                    ...
                    if (filesChecklist.toLowerCase().includes(entry.toLowerCase())) {
                        ...
                        document.getElementById("editors").appendChild(fileContainer)
...
function getScope(e) {
    if (e.parentNode.parentNode.parentNode.parentNode.childNodes[0].innerHTML.includes("@")) {
        scope = e.parentNode.parentNode.parentNode.parentNode.childNodes[0].innerHTML
    }
    else {
        return undefined
    }
...
function getValues(element) {
    if (element.id == "sliderBox") {
        return element.childNodes[1].childNodes[0].value + element.childNodes[1].childNodes[1].selectedOptions[0].text
    }
